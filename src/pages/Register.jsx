...
export default function Register() {
  ...
  const { sessionId, setBusiness } = useAppStore();
  const [form, setForm] = useState({ name: '', state: '', scheme_type: 'regular' });
      ...
      <Box maxWidth={580} mx="auto" px={{ xs: 0, sm: 1 }}>
        <Card>
          <CardContent sx={{ p: { xs: 3, md: 4 }, textAlign: 'center' }}>
            ...
            <Typography variant="h4" fontWeight={700} gutterBottom>Business Registered!</Typography>
            <Typography color="text.secondary" sx={{ mb: 3 }}>
              Your simulated GSTIN has been generated successfully.
            </Typography>
